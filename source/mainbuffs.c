...
const vertex main_button[] =
{
	...
	{ {45.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {85.0f, 223.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {45.0f, 223.0f,0.05f},{0.0f,0.0f,0.0f}},

	{ {45.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {85.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {85.0f, 223.0f,0.05f},{0.0f,0.0f,0.0f}},
	
	//left bottom
	{ {58.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {53.0f,218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {53.0f, 204.0f,0.05f},{0.0f,0.0f,0.0f}},

	{ {53.0f,  204.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {58.0f,  204.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {58.0f,  218.0f,0.05f},{0.0f,0.0f,0.0f}},
	

	//right bottom
	{ {77.0f, 204.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {77.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {72.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},

	
	{ {72.0f, 218.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {72.0f, 204.0f,0.05f},{0.0f,0.0f,0.0f}},
	{ {77.0f, 204.0f,0.05f},{0.0f,0.0f,0.0f}},
};
...
const vertex* sliderref=&slider[0];
const vertex* sliderlimitsref=&sliderlimits[0];
const vertex* mainbuttref=&main_button[0];
